 ...
 * https://modernizr.com/download/?-cssanimations-csstransforms-csstransforms3d-csstransitions-fontface-passiveeventlisteners-preserve3d-webgl-webglextensions-setclasses !*/
! function(e, t, n) {
    function r(e, t) {
        return typeof e === t
    }
    ...
    function p(t, r) {
        ...
        if ("CSS" in e && "supports" in e.CSS) {
            for (; s--;)
                if (e.CSS.supports(u(t[s]), r)) return !0;
            return !1
        }
    ...
    function g(e, t, s, o) {
        ...
        for (var u, d, g, m, h, v = ["modernizr", "tspan", "samp"]; !P.style && v.length;) u = !0, P.modElem = a(v.shift()), P.style = P.modElem.style;
        for (g = e.length, d = 0; g > d; d++)
            if (m = e[d], h = P.style[m], i(m, "-") && (m = c(m)), P.style[m] !== n) {
                if (o || r(s, "undefined")) return l(), "pfx" == t ? m : !0;
                try {
                    P.style[m] = s
                } catch (y) {}
                if (P.style[m] != h) return l(), "pfx" == t ? m : !0
            }
        return l(), !1
    }
    ...
    function h(e, t, n) {
        var s;
        for (var o in e)
            if (e[o] in t) return n === !1 ? e[o] : (s = t[e[o]], r(s, "function") ? m(s, n || t) : s);
        return !1
    }
    ...
    function v(e, t, n, s, o) {
        ...
        return r(t, "string") || r(t, "undefined") ? g(a, t, s, o) : (a = (e + " " + z.join(i + " ") + i).split(" "), h(a, t, n))
    }
    ...
    var C = [],
        ...
        T = "Moz O ms Webkit",
        _ = x._config.usePrefixes ? T.split(" ") : [];
    x._cssomPrefixes = _;
    var E = {
        elem: a("modernizr")
    };
    ...
    var z = x._config.usePrefixes ? T.toLowerCase().split(" ") : [];
    x._domPrefixes = z, x.testAllProps = v, x.testAllProps = y, Modernizr.addTest("cssanimations", y("animationName", "a", !0));
    ...
    A ? Modernizr.addTest("fontface", !1) : k('@font-face {font-family:"font";src:url("https://")}', function(e, n) {
    ...
    var N = "CSS" in e && "supports" in e.CSS,
        R = "supportsCSS" in e;
    Modernizr.addTest("supports", N || R), Modernizr.addTest("csstransforms3d", function() {
        ...
        if (Modernizr.webglextensions = !1, Modernizr.webgl) {
            var e, t, r;
            try {
                e = a("canvas"), t = e.getContext("webgl") || e.getContext("experimental-webgl"), r = t.getSupportedExtensions()
            } catch (s) {
                return
            }
            t !== n && (Modernizr.webglextensions = new Boolean(!0));
            for (var o = -1, i = r.length; ++o < i;) Modernizr.webglextensions[r[o]] = !0;
            e = n
        }
 ...
 * 
 * detects: mobile, tablet, pc, windows, mac, linux, ios, android, edge, ie, safari, chrome, firefox, opera, webview
!*/
! function(e, o) {
    function a(e) {
    ...
    var i = {};
    i._detects = ["mobile", "tablet", "pc", "windows", "mac", "linux", "ios", "android", "edge", "ie", "safari", "chrome", "firefox", "opera", "webview"];
    ...
    try {
        i.safari = a("safari") && !a("android") && !a("edge") && !a("opera") && !a("opr/d+.d+") && !a("chrome"), i.safari && (i.safari = new Boolean(!0), n.match(/version\/([\d.]+)/g) && (i.safari.version = r(RegExp.$1)))
    } catch (e) {}
    try {
        i.chrome = a("chrome") && !a("edge") && !a("opera") && !a("opr/d+.d+"), i.chrome && (i.chrome = new Boolean(!0), n.match(/chrome\/([\d.]+)/g) && (i.chrome.version = r(RegExp.$1)))
    } catch (e) {}
    try {
        i.firefox = a("firefox") && !a("edge"), i.firefox && (i.firefox = new Boolean(!0), n.match(/firefox\/([\d.]+)/g) && (i.firefox.version = r(RegExp.$1)))
    } catch (e) {}
    try {
        i.opera = a("opera") || a("opr/d+.d+"), i.opera && (i.opera = new Boolean(!0), n.match(/(opera|opr)\/([\d.]+)/g) && (i.opera.version = r(RegExp.$2)))
    } catch (e) {}
    try {
        i.webview = (a("iphone") || a("ipad") || a("ipod")) && (!a("safari") || a("crios") || a("fxios") || a("opios") || a("twitter") || a("fbav") || a("line"))
    } catch (e) {}
    var t, d, c, s = i._classPrefix = "",
        p = o.documentElement,
        l = p.className;
    for (d = i._detects.length, t = 0; t < d; t++) c = i._detects[t], i[c] ? l += " " + s + c : l += " " + s + "no-" + c;
...
! function(e, r) {
    var a, n, o = {},
        t = ["primary", "secondary"],
        s = t.length;
    !Modernizr.webgl || Useragnt.ie || Useragnt.ios && Useragnt.ios.version.major < 9 || Useragnt.android && (Useragnt.android.version.major < 5 || !Useragnt.chrome || Useragnt.chrome.version.float < 35) ? o.primary = !1 : (a = r.createElement("canvas")) && (n = a.getContext("webgl") || a.getContext("experimental-webgl")) && (o.primary = !!n.getShaderPrecisionFormat), o.secondary = !o.primary;
    var i, m, g = r.documentElement,
        c = g.className;
    for (i = 0; i < s; i++) m = t[i], o[m] ? c += " " + m : c += " no-" + m;
    g.className = c, e.Allocatr = o
}(window, document);